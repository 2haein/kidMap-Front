...
import com.safekid.safe_map.FHome.ErrandItemActivity;
...
public class CErrandRecyclerAdapter  extends RecyclerView.Adapter<CErrandRecyclerAdapter.ViewHolder>{
    ...
    private com.safekid.safe_map.FHome.ErrandRecyclerAdapter.OnItemClickEventListener mItemClickListener;

    public void setOnItemClickListener(com.safekid.safe_map.FHome.ErrandRecyclerAdapter.OnItemClickEventListener a_listener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView, final com.safekid.safe_map.Login.StdRecyclerAdapter.OnItemClickEventListener a_itemClickListener) {
            super(itemView);
