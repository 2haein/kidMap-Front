...
public class QCheckRecyclerAdapter extends RecyclerView.Adapter<QCheckRecyclerAdapter.ItemViewHolder> {
    ...
    public QCheckRecyclerAdapter(Context mContext, ArrayList<com.safekid.safe_map.FHome.QuestData> mArrayList) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(com.safekid.safe_map.FHome.QuestData data) {
